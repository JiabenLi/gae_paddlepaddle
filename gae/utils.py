...
def mask_test_edges(adj):
    ...
    all_edge_idx = np.load('all_edge_idx.npy')
    ...
    # all_i_test = []
    # all_j_test = []
    all_i_test = np.load('all_i_test.npy')
    all_j_test = np.load('all_j_test.npy')
    sum_test = 0
    ...
    # all_i_val = []
    # all_j_val = []
    all_i_val = np.load('all_i_val.npy')
    all_j_val = np.load('all_j_val.npy')
    sum_val = 0
