...
from utils import load_data, mask_test_edges_train, preprocess_graph, get_roc_score
...
def gae_for(args):
    ...
    adj_train, train_edges, val_edges, val_edges_false, test_edges, test_edges_false = mask_test_edges_train(adj, args.data_path)
    adj = adj_train
